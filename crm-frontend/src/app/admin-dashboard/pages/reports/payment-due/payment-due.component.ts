...
export class PaymentDueComponent implements OnInit, OnDestroy {
  ...
  initializeColumns(): void {
    this.columnDefs = [
      { headerName: 'Invoice ID', field: 'invoice_number', flex:1},
      { headerName: 'Company', field: 'company_name', flex: 1 },
      { headerName: 'Amount', field: 'amount', flex:1, valueFormatter: this.currencyFormatter.bind(this) },
      { headerName: 'Paid', field: 'amount_paid', flex:1, valueFormatter: this.currencyFormatter.bind(this) },
      { headerName: 'Balance Due', field: 'balance_due', flex:1, valueFormatter: this.currencyFormatter.bind(this) },
      { headerName: 'Due Date', field: 'due_date', flex:1, valueFormatter: this.dateFormatter.bind(this) },
